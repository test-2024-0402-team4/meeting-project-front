...
import { registerDeclare, registerTeacherDeclare } from "../../apis/api/boardApi";
...
function DeclareTeacherPage(props) {
    useAuthCheck();
    useTeacherCheck();
    ...
    const registerTeacherDeclareMutation = useMutation({
        mutationKey: "registerTeacherDeclareMutation",
      ...
      const handleSubmitClick = () => {
        ...
        if(window.confirm("글을 작성하시겠습니까?")){
            registerTeacherDeclareMutation.mutate(board); 
        }
      }
...
export default DeclareTeacherPage;
