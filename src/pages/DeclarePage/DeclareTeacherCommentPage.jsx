...
import { registerDeclare, registerStudentCommentDeclare, registerTeacherCommentDeclare } from "../../apis/api/boardApi";
...
function DeclareTeacherCommentPage(props) {
    ...
    const registerTeacherCommentDeclareMutation = useMutation({
        mutationKey: "registerTeacherCommentDeclareMutation",
      ...
      const handleSubmitClick = () => {
        ...
        const board = {
          userId: userId,
          teacherCommentId: params.teacherCommentId,
          theme : selectedTitle,
          content : inputValue2
        };
        ...
        if(window.confirm("글을 작성하시겠습니까?")){
            registerTeacherCommentDeclareMutation.mutate(board); 
        }
      }
...
export default DeclareTeacherCommentPage;
