...
import { registerDeclare, registerStudyDeclare } from "../../apis/api/boardApi";
...
function DeclareStudyPage(props) {
    ...
    const registerStudyDeclareMutation = useMutation({
        mutationKey: "registerStudyDeclareMutation",
      ...
      const handleSubmitClick = () => {
        ...
        if(window.confirm("글을 작성하시겠습니까?")){
            registerStudyDeclareMutation.mutate(board); 
        }
      }
...
export default DeclareStudyPage;
