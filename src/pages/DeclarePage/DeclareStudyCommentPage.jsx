...
import { registerDeclare, registerStudentCommentDeclare, registerStudyCommentDeclare } from "../../apis/api/boardApi";
...
function DeclareStudyCommentPage(props) {
    useAuthCheck();
    ...
    const registerStudyCommentDeclareMutation = useMutation({
        mutationKey: "registerStudyCommentDeclareMutation",
        mutationFn: registerStudyCommentDeclare,
        onSuccess: response => {
          alert("신고가 완료되었습니다");
          navigate("/");
        }
      ...
      const handleSubmitClick = () => {
        ...
        const board = {
          userId: userId,
          studyCommentId: params.studyCommentId,
          theme : selectedTitle,
          content : inputValue2
        };
        ...
        if(window.confirm("글을 작성하시겠습니까?")){
            registerStudyCommentDeclareMutation.mutate(board); 
        }
      }
...
export default DeclareStudyCommentPage;
