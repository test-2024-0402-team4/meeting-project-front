...
import { registerDeclare, registerStudentCommentDeclare } from "../../apis/api/boardApi";
...
function DeclareStudentCommentPage(props) {
    ...
    const registerStudentCommentDeclareMutation = useMutation({
        mutationKey: "registerStudentCommentDeclareMutation",
        mutationFn: registerStudentCommentDeclare,
        onSuccess: response => {
          alert("신고가 완료되었습니다");
      ...
      const handleSubmitClick = () => {
        ...
        const board = {
          userId: userId,
          studentCommentId: params.studentCommentId,
          theme : selectedTitle,
          content : inputValue2
        };
        ...
        if(window.confirm("글을 작성하시겠습니까?")){
            registerStudentCommentDeclareMutation.mutate(board); 
        }
      }
...
export default DeclareStudentCommentPage;
